...
| `DSH_SAFE_NO_UPDATE_CHECK=1` | Disable boot-time notices (the at-most-daily dsh-safe new-version notice, the dsh non-`latest` channel-gap hint); explicit `update` / `--check` are unaffected |
